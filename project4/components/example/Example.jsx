...
class Example extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      motto1: window.cs142models.exampleModel().motto,
      motto2: window.cs142models.exampleModel().motto,
      counter: 0,
      inputValue: '',
      buttonWasClicked: '',
    };
    ...
    this.handleMottoSubmit = this.handleMottoSubmit.bind(this);
  ...
  handleMottoChange(event) {
    this.setState({motto2: event.target.value});
  }

  handleMottoSubmit(event) {
    alert('Motto- г өөрчиллөө: ' + this.state.motto2);
    this.setState({motto1: this.state.motto2});
    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          {this.state.motto1}. /{this.state.name} - 17b1num2256/
          
          <form onSubmit={this.handleMottoSubmit}>
            <label>
              Update motto : 
               <input type="text" value={this.state.motto2} onChange={this.handleMottoChange} />
            </label>
